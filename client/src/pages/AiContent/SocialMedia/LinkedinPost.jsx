...
async function handleSubmit(e, currentColor, form, responseContainer, chatContainer, submitButton) {
  ...
  if (date) {
    ...
    prompt = `Hello AI bot! I'd like you to create a Linkedin post about; ${mainMessage}. Some more specific information; ${specificInfo}. My target audience is ${target}. I'd like the post to have ${tone} tone and include a call to action for users to ${callToActionR}. Please include relevant hashtags. The post should include ${postFormat}. Thank you!`
        ...
        >
          ...
          >
            <select
              ...
              id="target-audience"
            >
              <option value=" any regular Linkedin user">🚫 Default</option>
