  ...
  return (
    <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-30 rounded-xl w-full lg:w-full p-8 pt-9 m-3 bg-no-repeat bg-cover bg-center">
      <div className="flex justify-between items-center ">
        <div>
          <p className="font-bold text-gray-700 dark:text-gray-200 text-left mb-2 capitalize">Create the perfect personalized email</p>
          <p
            className="text-s"
            style={{ color: currentColor }}
          >
            Relay AI's personalized email copy writer, generated by AI, is the perfect tool for delivering impactful, persuasive emails to your customers. With this revolutionary technology, you can craft emails that truly understand and connect with your customers. Tailor-made for each audience, Relay AI's personalized emails will help you stand out from the competition by delivering messages that are unique and highly effective. Our AI-powered copywriter helps you write high-quality content in a fraction of the time it would take to manually create the same message. From better engagement to sky-high ROI, our solution puts you ahead of the game — all at a fraction of the cost. Try Relay AI today and take advantage of the power of personalized emails that are sure to improve customer engagement and conversions.
          </p>
        </div>
      </div>
    </div>
