...
async function handleSubmit(e, currentColor, form, responseContainer, chatContainer, submitButton) {
  ...
  const prompt = `Hello AI bot, give me a TikTok video script for ${product}. After that give me a relevant caption with hashtags that I can add below the video. Separate the script and the caption. The script can be as long or as short as it needs to be. I prefer ${tone} tone and please don't make it cringe. Thank you.`;
  ...
  return (
    <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-30 rounded-xl w-full lg:w-full p-8 pt-9 m-3 bg-no-repeat bg-cover bg-center">
      <div className="flex justify-between items-center ">
        <div>
          <p className="font-bold text-gray-700 dark:text-gray-200 text-left mb-2">Generate TikTok Video Scripts</p>
          <p
            className="text-s"
            style={{ color: currentColor }}
          >
            Looking for a way to generate engaging videos for TikTok? Look no further than Relay AI! Create unique and eye-catching scripts that will make your videos stand out from the crowd. Whether you’re looking to create educational, inspirational, or entertaining content, this powerful tool has got you covered. Try it now and see how easy it is to generate engaging videos in no time!
          </p>
        </div>
      </div>
    </div>
        ...
        >
          ...
          <div>
            <label
              ...
              What Product Would You Like to get a script for?
            </label>
            <p
              style={{ color: currentColor }}
          ...
          <div>
            ...
            <p
              style={{ color: currentColor }}
              className="text-xs italic mb-2 font-bold">
...
class TikTokScript extends React.Component {
  render() {
    return (
      <div className="mt-10">
