      ...
      <div className="flex justify-between items-center ">
        <div>
          <p className="font-bold text-gray-700 dark:text-gray-200 text-left mb-2 capitalize">
            Create the perfect Follow-Up email
          </p>
          <p className="text-s" style={{ color: currentColor }}>
            Relay AI's follow-up email copy writer, generated by AI, is the perfect tool to take your email outreach to the next level. With AI-driven analysis of recipient behavior, this powerful tool helps you customize each message to increase engagement and maximize sales opportunities. Forget manually typing in each email; just choose a template, plug in your contact information, and let AI do the work. Time consuming manual tasks can be offloaded to a machine learning system that quickly and intelligently optimizes your email follow-ups for better results. Don't waste time trying to guess what works best for your contacts; let Relay AI do the heavy lifting for you. Get more out of every outreach campaign with Relay AI's follow-up email copy writer and start converting more leads today!
          </p>
        </div>
      </div>
    </div>
