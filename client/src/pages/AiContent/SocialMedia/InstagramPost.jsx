...
async function handleSubmit(e, currentColor, form, responseContainer, chatContainer, submitButton) {
  ...
  if (date) {
    ...
    prompt = `Hello AI bot! I'd like you to create a Instagram post about; ${mainMessage}. Some more specific information; ${specificInfo}. My target audience is ${target}. I'd like the post to have ${tone} tone and include a call to action for users to ${callToActionR}. Please include relevant hashtags. The post should include ${postFormat}. Thank you!`
  ...
  return (
    <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-30 rounded-xl w-full lg:w-full p-8 pt-9 m-3 bg-no-repeat bg-cover bg-center">
      <div className="flex justify-between items-center ">
        <div>
          <p className="font-bold text-gray-700 dark:text-gray-200 text-left mb-2">Create The Perfect Instagram Post</p>
          <p
            className="text-s"
            style={{ color: currentColor }}
          >
            Relay AI's Instagram Post Generator Bot is the perfect tool for busy entrepreneurs, marketers and small business owners who want to quickly and easily create impactful posts on their Instagram page. Generate posts in a matter of seconds that will drive traffic, engage your followers and build your brand. Forget about spending hours crafting the perfect message - with Relay AI you can go from idea to post with lightning speed. Make your Instagram page stand out and give it a professional edge in no time at all!
          </p>
        </div>
      </div>
    </div>
        ...
        >
          ...
          >
            <select
              ...
              id="target-audience"
            >
              <option value=" any regular Instagram user">🚫 Default</option>
