      ...
      <div className="flex justify-between items-center ">
        <div>
          <p className="font-bold text-gray-700 dark:text-gray-200 text-left mb-2 capitalize">
            Create the perfect email reply
          </p>
          <p className="text-s" style={{ color: currentColor }}>
            Relay AI's email reply copy writer, generated by AI, is the perfect solution for those looking to save time and money. This versatile tool helps you create professional, persuasive emails quickly and easily. With natural-language processing and AI-driven curation of content, you can create impactful emails that deliver maximum ROI in minimal time. Forget spending hours crafting your own email message - let Relay AI do the hard work for you while you focus on doing what matters most to you. Cut through tedious copywriting tasks with Relay AI's top-of-the-line copy writer and get the best results in no time!
          </p>
        </div>
      </div>
    </div>
